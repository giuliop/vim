" ============================================================================
" Name:     giulius vim color scheme
" Author:   Giulio Pizzini <giuliop@gmail.com>
" Version:  1.0
" ----------------------------------------------------------------------------
" Inspired by giulius colorscheme by Jonathan Filip <jfilip1024@gmail.com>
"
" Options:
"
" g:giulius_use_bold (default: 1)
"
" Setting this will cause the color scheme to use bold fonts for some items.
"
" g:giulius_use_underline (default: 1)
"
...
if exists("g:giulius_use_bold")
    let s:use_bold = g:giulius_use_bold
else
    let s:use_bold = 1
endif

if exists("g:giulius_use_underline")
    let s:use_underline = g:giulius_use_underline
else
...
hi htmlTag      guifg=#8a8a8a
hi htmlEndTag   guifg=#8a8a8a
hi htmlArg      guifg=#af87af
